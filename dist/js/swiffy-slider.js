  ...
  var swiffyslider = /* @__PURE__ */ function() {
    return {
      ...
      initSlider(sliderElement) {
        sliderElement.querySelectorAll(".slider-nav").forEach(
          (navElement) => navElement.addEventListener("click", () => this.slide(sliderElement, navElement.classList.contains("slider-nav-next")), { passive: true })
        );
